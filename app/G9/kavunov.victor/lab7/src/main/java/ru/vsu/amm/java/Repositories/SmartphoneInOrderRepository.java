...
import ru.vsu.amm.java.Mappers.Mapper;
...
public class SmartphoneInOrderRepository implements CrudRepository<SmartphoneInOrder> {
    ...
    public Optional<SmartphoneInOrder> findById(Long id) {
        String query = "SELECT OrderNum, SmartphineID, Anount " +
                "FROM SmartphonesInOrders WHERE SmartphonesInOrdersID = ?;";
