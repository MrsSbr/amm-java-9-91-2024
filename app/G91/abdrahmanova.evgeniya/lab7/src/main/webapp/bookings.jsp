    ...
    <div class="header">
        <div class="user-info">
            <div class="user-avatar">
                <c:set var="userName" value="${sessionScope.user.fullName()}" />
                        ...
                        <c:if test="${booking != null}">
                            <div class="booking-item">
                                <div class="booking-photo">
                                    <div class="booking-photo-placeholder">🏔️</div>
                                    <!-- <img src="/images/tours/${booking.idTour()}.jpg" alt="Фото тура"> -->
                                </div>
                                            ...
                                            <div class="meta-value">
                                                <c:choose>
                                                    <c:when test="${booking.totalPrice() != null}">
                                                        <fmt:formatNumber value="${booking.totalPrice()}" type="currency" currencyCode="RUB" currencySymbol="₽"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        Не указана
                                                    </c:otherwise>
