...
<head>
  <meta charset="UTF-8">
  <title>Мои сессии (Психолог)</title>
...
<div class="header">
  <h1>Мои сессии</h1>
  <!-- Кнопка для переключения на клиентскую авторизацию -->
...
<div class="container">
  <!-- таблица со списком сессий психолога -->
  <table id="sessionsTable">
    ...
    <c:forEach var="s" items="${sessions}">
      <!-- каждая строка помечена data-id для JS -->
...
<script>
  ...
  // по клику на строку показываем меню
  ...
  // скрываем меню при клике не по строке и не по самому меню
