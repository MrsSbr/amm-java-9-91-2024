...
dependencies {
    ...
    implementation ("org.apache.tomcat:tomcat-jsp-api:11.0.3")
    implementation ("org.apache.tomcat:tomcat-jasper:11.0.3")
    implementation ("org.apache.tomcat:tomcat-jasper-el:11.0.3")
}
