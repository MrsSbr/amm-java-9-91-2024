...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h1 class="form-title">Редактировать доску</h1>

            <c:if test="${not empty error}">
                <div class="error-message">${error}</div>
            </c:if>

            <form action="${pageContext.request.contextPath}/boards/${board.boardID}" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description">${board.boardDescription}</textarea>
                </div>
                <div>
                    <button type="submit" class="btn">Сохранить</button>
                    <c:choose>
                        <c:when test="${referer == 'view'}">
                            <button type="button" onclick="window.location.href='/boards/${board.boardID}'"
